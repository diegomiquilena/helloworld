...
def show(client):
    print("{}: {} {}".format(client['dni'], client['nombre'], client['apellido']))
...
def edit():
    ...
    if client:
        ...
        print("Introduce nuevo nombre ({})".format(client['nombre']))
        clients[i]['nombre'] = helpers.input_text(2, 30)

        print("Introduce nuevo apellido ({})".format(client['apellido']))
